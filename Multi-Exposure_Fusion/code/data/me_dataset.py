...
from .me_dataset_ir import DatasetIR
import cv2

class DatasetMultiExposure(DatasetIR):
    ...
    def __getitem__(self, index: int) -> Dict[str, Union[str, torch.Tensor]]:
        ...
        if self.opt['phase'] == 'train':
            ...
            # cv2.imwrite('H.png',patch_H)
            # cv2.imwrite('L.png',patch_L)
            # cv2.imwrite('G.png',patch_Guide)
