...
from models.MMIF_MF_select_network import select_network
...
class Model:
    ...
    def save_visuals(self, tag: str):
        ...
        util.imsave(rh_img[self.rnn_iter-1], img_path)
        # for i in range(self.rnn_iter):
    ...
    def get_freeze_head(self):
        ...
        freeze.freeze_by_names(self.net.module, ('heady'))
    def get_unfreeze_head(self):
        import freeze
        freeze.unfreeze_by_names(self.net.module, ('headx'))
        freeze.unfreeze_by_names(self.net.module, ('heady'))
    def get_freeze_part1(self):
        import freeze
        freeze.freeze_by_names(self.net.module.body_listx, ('0'))
        freeze.freeze_by_names(self.net.module.body_listy, ('0'))
    def get_unfreeze_part1(self):
        import freeze
        freeze.unfreeze_by_names(self.net.module.body_listx, ('0'))
        freeze.unfreeze_by_names(self.net.module.body_listy, ('0'))
    def get_freeze_part2(self):
        import freeze
        freeze.freeze_by_names(self.net.module.body_listx, ('1'))
        freeze.freeze_by_names(self.net.module.body_listy, ('1'))
    def get_unfreeze_part2(self):
        import freeze
        freeze.unfreeze_by_names(self.net.module.body_listx, ('1'))
        freeze.unfreeze_by_names(self.net.module.body_listy, ('1'))
    def get_freeze_FB1(self):
        import freeze
        freeze.freeze_by_names(self.net.module.FB_list, ('0'))
    def get_unfreeze_FB1(self):
        import freeze
        freeze.unfreeze_by_names(self.net.module.FB_list, ('0'))
    def train(self,i):
