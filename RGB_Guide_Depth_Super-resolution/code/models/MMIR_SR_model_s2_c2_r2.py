...
from models.MMIR_SR_select_network import select_network
...
class Model:
    ...
    def save(self, logger: Logger):
        ...
        for i in range(self.rnn_iter):
            for j in range(self.c_iter):
                self.save_network(net.headx.head_list[j], 'headx_' + str(i) + '_c' +str(j))
    ...
    def save_best(self, logger: Logger):
        ...
        for i in range(self.rnn_iter):
            for j in range(self.c_iter):
                self.save_network(net.headx.head_list[j], 'headx_' + str(i) + '_c' + str(j), best=True)
