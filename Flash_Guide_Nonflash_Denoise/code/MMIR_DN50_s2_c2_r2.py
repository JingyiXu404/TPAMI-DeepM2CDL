...
from models.MMIR_DN_model_50_s2_c2_r2 import Model
...
def main(json_path: str = 'options/MMIR_DN_train_50_s2_c2_r2.json'):
    ...
    for epoch in range(1,1000000):  # keep running
        for train_data in tqdm(train_loader):
            ...
            if current_step % opt['train']['checkpoint_log'] == 0:
                GL,XL,XLL,YL,XH=model.log_train(current_step, epoch, logger,GL,XL,XLL,YL,XH,'debug/MMIR_DN50_s2_c2_r2.png')
