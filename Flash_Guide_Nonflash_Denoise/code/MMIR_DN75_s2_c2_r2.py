...
def main(json_path: str = 'options/MMIR_DN_train_75_s2_c2_r2.json'):
    ...
    for epoch in range(1,1000000):  # keep running
        for train_data in tqdm(train_loader):
            ...
            if current_step % opt['train']['checkpoint_log'] == 0:
                GL,XL,XLL,YL,XH=model.log_train(current_step, epoch, logger,GL,XL,XLL,YL,XH,'debug/MMIR_DN75_s2_c2_r2.png')
