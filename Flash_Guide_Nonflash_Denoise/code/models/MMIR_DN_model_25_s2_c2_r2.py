...
class Model:
    ...
    def get_freeze_rnn1_c1(self):
        import freeze
        freeze.freeze_by_names(self.net.module.heady_list[0].head_list, ('0'))
        ...
        freeze.freeze_by_names(self.net.module.RB_list[0].RB_list, ('0'))
    def get_freeze_rnn1_c2(self):
        import freeze
        freeze.freeze_by_names(self.net.module.heady_list[0].head_list, ('1'))
        ...
        freeze.freeze_by_names(self.net.module.RB_list[0].RB_list, ('1'))
